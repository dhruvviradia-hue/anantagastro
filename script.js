...
const guideContent = {
  ...
  endoscopy: {
    ...
    text: "Symptoms like persistent acidity, vomiting, swallowing difficulty or upper abdominal pain may need medical review and sometimes upper GI endoscopy."
  },
  colon: {
...
contactForm?.addEventListener("submit", (event) => {
  ...
  formSuccess.textContent = `Thank you, ${name}. Your request for ${service} is ready. The clinic can connect this form to WhatsApp, email or a backend.`;
